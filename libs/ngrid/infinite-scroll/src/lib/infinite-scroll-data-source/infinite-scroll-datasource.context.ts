...
import { PblDataSourceTriggerChangedEvent, DataSourceOf, PblDataSourceConfigurableTriggers } from '@perbula/ngrid/core';
...
declare module '@perbula/ngrid/core/lib/data-source/adapter/types' {
