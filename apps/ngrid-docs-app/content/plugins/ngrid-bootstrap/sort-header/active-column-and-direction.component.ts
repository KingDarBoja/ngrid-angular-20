...
@Component({
  selector: 'pbl-bs-active-column-and-direction-example',
...
@Example('pbl-bs-active-column-and-direction-example', { title: 'Sorting with default active column and direction' })
