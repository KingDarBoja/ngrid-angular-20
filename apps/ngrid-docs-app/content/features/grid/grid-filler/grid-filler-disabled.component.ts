...
@Component({
  selector: 'pbl-grid-filler-disabled-example',
  templateUrl: './grid-filler-disabled.component.html',
  styleUrls: ['./grid-filler-disabled.component.scss'],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
@Example('pbl-grid-filler-disabled-example', { title: 'Grid Filler Disabled' })
export class GridFillerDisabledExample {
